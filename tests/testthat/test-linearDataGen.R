test_that("Output is a list containing two data frames", {
  output <- linearDataGen(y_int = 0, slope = 1, sigma = 1)
...
test_that("point_data and line_data columns exist in both dataframes", {
  output <- linearDataGen(y_int = -5.5,slope=3.12,sigma=10,N=100,x_min=-10,x_max=30)
...
test_that("Minimum and maximum x values are correct", {
  output <- linearDataGen(y_int = 0, slope = 1, sigma = 1, x_min = 5, x_max = 30)
