...
-   **Change color Checkbox:** Enables users to change colors for different parts of the app, including the progress region color, drawn line color, and regression line & confidence interval color (which display upon completion of drawn line). A drop-down menu and color palette appear upon checking this box.
...
3.  Optionally, load your data by clicking Input Data or create simulated data by clicking Simulate Data and choosing any of the options displayed.
...
6.  Save the recorded data for later use by clicking Save Data.
