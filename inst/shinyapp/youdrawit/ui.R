      ...
      column(
        ...
        div(style = "position: relative;",
            ...
            div(class = "dropdown",
                ...
                actionButton(inputId = "dropdownMenuButton",
                             label = "Change Data", 
                ...
                div(class = "dropdown-menu",
                    ...
                    actionLink(inputId = "inputData", label = "Input Data", 
                               style = "display: block; padding-left: 10px;"),
                    actionLink(inputId = "simulateData", label = "Simulate Data",
                               style = "display: block; padding-left: 10px;"),
                    actionLink(inputId = "rDataset", label = "Use R Dataset",
                               style = "display: block; padding-left: 10px;")
                ),
            ),
